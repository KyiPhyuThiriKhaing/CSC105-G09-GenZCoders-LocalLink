...
export default function AdminSubmissionDetailsPanel({
  submission,
  isOpen,
  onClose,
        ...
        {submission ? (
          <div className="flex min-h-full flex-col">
            ...
            <div className="flex-1 space-y-5 px-4 py-5 sm:px-6">
              ...
              <span
                className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold ${STATUS_STYLES[submission.status]}`}
              >
                {submission.status}
              </span>
                ...
                <dl className="mt-3 grid grid-cols-1 gap-2 text-sm text-(--color-text-muted) sm:grid-cols-2">
                  ...
                  <div className="flex items-start gap-2 rounded-lg bg-white/70 p-2">
                    ...
                    <div>
                      ...
                      <dd className="mt-0.5 font-medium text-(--color-ink-strong) break-all">
                        {submission.email}
                      </dd>
                    </div>
                  </div>
              ...
              <section>
                ...
                <p className="mt-2 rounded-xl border border-(--color-ink-border-faint) bg-white p-3 text-sm leading-relaxed text-(--color-text-muted)">
                  {submission.notes}
                </p>
              </section>
            ...
            <div className="sticky bottom-0 border-t border-(--color-ink-border-faint) bg-white px-4 py-4 sm:px-6">
              <h3 className="text-sm font-bold text-(--color-ink-strong)">
                Admin Actions
              </h3>
              <textarea
