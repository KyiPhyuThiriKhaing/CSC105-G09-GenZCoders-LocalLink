...
export const MOCK_HISTORY_APPLIED = [
    { title: "Lawn Mowing Service", location: "Thong Lo, Bangkok", price: "฿350", status: "Contacted" },
    { title: "Dog Walking", location: "Lumphini Park, Bangkok", price: "฿200", status: "Pending" },
    { title: "Grocery Delivery", location: "Phrom Phong, Bangkok", price: "฿250", status: "Pending" },
];
