...
export const MOCK_ADMIN_SUBMISSIONS: Submission[] = [
  {
    ...
    documents: [
      "National ID.pdf",
      "Utility Bill.pdf",
      "Selfie Verification.jpg",
    ],
    notes:
      "Recently moved to a new address and uploaded the latest utility bill for verification.",
  },
  {
    id: 2,
    name: "Ava Martinez",
  ...
  },
  {
    ...
    notes:
      "Identity document is expired. User should upload a valid government ID.",
  },
  {
    id: 4,
    name: "Sophia Ahmed",
  ...
  },
  {
    ...
    notes:
      "Address proof is valid but profile photo has glare; may request re-upload.",
  },
  {
    id: 7,
    name: "Lucas Brooks",
  ...
  },
  {
    ...
    notes:
      "Awaiting confirmation for one supporting document that appears cropped.",
  },
];
