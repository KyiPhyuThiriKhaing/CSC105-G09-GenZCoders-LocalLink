    ...
    <div className="max-w-4xl space-y-12 pb-10">
      <div className="group relative -mx-4 overflow-hidden rounded-b-[3rem] bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 pb-16 pt-32 sm:-mx-6 sm:rounded-[3rem] sm:pt-40 lg:-mx-8 lg:rounded-[4em]">
        ...
        <div className="relative z-10 mx-auto max-w-2xl px-6 text-center">
          <div className="relative mx-auto mb-6 h-32 w-32 shrink-0">
            ...
            />
            <button className="absolute -right-3 -bottom-3 flex h-12 w-12 items-center justify-center rounded-[1.2rem] bg-white text-slate-900 shadow-xl transition-all hover:bg-[var(--color-brand-soft)] hover:text-[var(--color-brand-primary)] hover:scale-110">
          ...
          <div className="mt-8 flex justify-center gap-4">
            <button className="flex items-center gap-2 rounded-2xl bg-white px-6 py-3 text-sm font-bold text-slate-900 transition-all hover:scale-105 hover:bg-[var(--color-brand-soft)] hover:text-[var(--color-brand-primary)] shadow-lg">
      ...
      <div className="grid gap-12 sm:grid-cols-3">
        ...
        <div className="sm:col-span-1 space-y-10">
          <section>
            <h2 className="mb-4 text-xs font-bold uppercase tracking-widest text-slate-400">About Me</h2>
        ...
        <div className="sm:col-span-2 space-y-12">
          <section>
            ...
            <p className="text-base leading-relaxed text-slate-600">{user.bio}</p>
          </section>

          <section>
            <div className="mb-6 flex items-center justify-between border-b border-slate-200 pb-4">
              <h2 className="text-xl font-bold text-slate-900">Skills & Services</h2>
            </div>
            <div className="flex flex-wrap gap-2">
              {user.skills.map((skill) => (
                <span
                  key={skill}
                  className="rounded-xl bg-slate-100 px-4 py-2 text-sm font-bold text-slate-700 transition-colors hover:bg-[var(--color-brand-soft)] hover:text-[var(--color-brand-primary)] cursor-pointer"
                >
                  {skill}
                </span>
              ))}
              <button className="flex items-center gap-1 rounded-xl border-2 border-dashed border-slate-200 px-4 py-1.5 text-sm font-bold text-slate-400 transition-colors hover:border-[var(--color-brand-primary)] hover:text-[var(--color-brand-primary)]">
                + Add Skill
              </button>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="border-l-2 border-slate-200 pl-4 transition-colors hover:border-[var(--color-brand-primary)]">
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex text-yellow-400 text-sm">★★★★★</div>
                  <span className="text-xs font-bold text-slate-400">2 days ago</span>
                </div>
                <p className="text-sm font-medium text-slate-700">"Great service! John was punctual and did a fantastic job with the lawn."</p>
                <p className="mt-1 text-xs font-bold text-slate-500">- Sarah M.</p>
              </div>
              <div className="border-l-2 border-slate-200 pl-4 transition-colors hover:border-[var(--color-brand-primary)]">
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex text-yellow-400 text-sm">★★★★★</div>
                ...
                <p className="text-sm font-medium text-slate-700">"Very helpful and polite. Highly recommended."</p>
                <p className="mt-1 text-xs font-bold text-slate-500">- Mike T.</p>
              </div>
            </div>
          </section>
        </div>
