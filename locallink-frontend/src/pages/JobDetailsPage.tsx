  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24 lg:pb-20">
      <div className="mx-auto max-w-5xl px-4 pt-8 sm:px-6 lg:px-8 lg:pt-12">
        <Link
          to="/jobs"
          className="group inline-flex items-center gap-2 mb-8 text-sm font-medium text-slate-500 transition-colors hover:text-slate-900"
        >
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-12">
                ...
                <div className="mt-8 flex flex-wrap gap-4 border-y border-slate-100 py-6">
                  <div className="flex items-center gap-3 rounded-2xl bg-slate-50 px-5 py-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white shadow-sm border border-slate-100">
                      <DrawingPinIcon className="h-5 w-5 text-(--color-brand-primary)" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-3 rounded-2xl bg-slate-50 px-5 py-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white shadow-sm border border-slate-100">
                      <ClockIcon className="h-5 w-5 text-(--color-brand-primary)" />
                    </div>
                    <div>
                      <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">
                        Duration
          ...
          <div className="hidden lg:col-span-4 lg:block">
            <div className="sticky top-28 space-y-6">
              <div className="rounded-4xl bg-white p-8 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.05)] border border-slate-100 text-center">
                <span className="inline-block rounded-full bg-(--color-brand-soft) px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-(--color-brand-primary)">
                  Payout
                </span>
                ...
                <div className="mt-8 flex flex-col gap-3">
                  <button className="w-full rounded-2xl bg-(--color-brand-primary) py-4 text-sm font-bold text-white shadow-lg shadow-(--color-brand-primary)/25 transition-all hover:scale-[1.02] hover:bg-(--color-brand-primary-hover)">
                    Apply Now
                  </button>
              ...
              <div className="rounded-4xl bg-white p-8 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.05)] border border-slate-100">
