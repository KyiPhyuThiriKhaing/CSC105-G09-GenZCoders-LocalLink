  ...
  const conversations = [
    {
      ...
      lastMessage: "Yes, 3 PM works for me!",
      time: "10:42 AM",
      unread: 2,
    },
    {
      ...
      lastMessage: "Can you bring your own tools?",
      time: "Yesterday",
      unread: 0,
    },
    {
      ...
      <div className="hidden sm:flex flex-1 flex-col bg-white">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50/50">
          <div className="flex items-end gap-2">
            ...
            <div className="rounded-2xl rounded-bl-none bg-white p-3 shadow-sm border border-slate-100 max-w-md">
              <p className="text-sm font-medium text-slate-800">
                Hi {currentUser.name.split(" ")[0]}! I saw your proposal for the
                pet sitting job this weekend. Are you still available?
              </p>
          ...
          <div className="flex items-end justify-end gap-2">
            <div className="rounded-2xl rounded-br-none bg-(--color-brand-primary) p-3 shadow-sm max-w-md">
              <p className="text-sm font-medium text-white">
                Yes, absolutely! I'm free all weekend. What times were you
                thinking?
              </p>
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="rounded-2xl rounded-bl-none bg-white p-3 shadow-sm border border-slate-100 max-w-md">
              <p className="text-sm font-medium text-slate-800">
                I need someone from Saturday morning until Sunday evening. We
                can discuss the exact feeding schedule if that works for you.
              </p>
              <span className="mt-1 block text-[10px] text-slate-400">
                10:40 AM
              </span>
        ...
        <div className="border-t border-slate-200 bg-white p-4">
          <div className="flex items-center gap-3 rounded-4xl border-2 border-slate-100 bg-slate-50 p-2 pl-4 focus-within:border-(--color-brand-primary) focus-within:bg-white focus-within:ring-4 focus-within:ring-(--color-brand-focus-ring) transition-all">
            <input
              type="text"
              placeholder="Type your message..."
              className="flex-1 bg-transparent text-sm font-medium text-slate-900 outline-none placeholder:text-slate-400"
            />
            <button className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-(--color-brand-primary) text-white shadow-md transition-transform hover:scale-105 hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-(--color-brand-primary) focus:ring-offset-2">
